...
CREATE TABLE `cmf_goods` (
  ...
  `preferential_price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '商品优惠价',
  ...
  PRIMARY KEY (`id`),
  KEY `cateid_brand_status` (`cate_id`,`brand`,`status`),
  KEY `sn` (`sn`),
  KEY `name` (`name`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE `cmf_combo` (
  ...
  KEY `createuserid_status` (`create_user_id`,`status`)
...
CREATE TABLE `cmf_combo_info` (
  ...
  `goods_unit_price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '商品单价',
  `unit` varchar(8) NOT NULL DEFAULT '' COMMENT '单位',
  ...
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`),
  KEY `comboid_status` (`combo_id`,`status`)
...
CREATE TABLE `cmf_order_info` (
  ...
  `goods_unit_price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '商品或套餐单价',
  ...
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`),
  KEY `orderid_status` (`order_id`,`status`)
...
CREATE TABLE `cmf_address` (
  ...
  `city_name` varchar(32) NOT NULL DEFAULT '' COMMENT '市名',
  `county_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '区县id',
  `county_name` varchar(32) NOT NULL DEFAULT '' COMMENT '区县名',
  `address` varchar(255) NOT NULL DEFAULT '' COMMENT '详细地址',
  `person` varchar(32) NOT NULL DEFAULT '' COMMENT '联系人',
  `phone` char(16) NOT NULL DEFAULT '' COMMENT '联系电话',
...
-- ----------------------------
-- Table structure for `cmf_invoice`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_invoice`;
CREATE TABLE `cmf_invoice` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '发票抬头',
  `no` varchar(24) NOT NULL DEFAULT '' COMMENT '票号',
  `content_type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '开票内容:1详细清单；2办公用品；3其他',
  `price` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '发票金额',
  `tax` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '税额',
  `drawer_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '开票人id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '开票日期',
  `remarks` varchar(255) NOT NULL DEFAULT '' COMMENT '开票备注',
  `status` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '状态：-1删除；0无效；1有效',
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`),
  KEY `userid_status` (`user_id`,`status`)
...
-- ----------------------------
-- Table structure for `cmf_invoice_info`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_invoice_info`;
CREATE TABLE `cmf_invoice_info` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `invoice_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '发票id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  ...
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`),
  KEY `invoiceid_status` (`invoice_id`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='发票明细表';

-- ----------------------------
-- Table structure for `cmf_office`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_office`;
CREATE TABLE `cmf_office` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `invoice_sn` varchar(24) NOT NULL DEFAULT '' COMMENT '税号',
  `status` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '状态：-1删除；1正常',
  `more` text COMMENT '扩展属性',
  PRIMARY KEY (`id`),
  KEY `name_status` (`name`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='公司管理表';

-- ----------------------------
-- Table structure for `cmf_points_log`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_points_log`;
CREATE TABLE `cmf_points_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '类型：1增加；2减少',
...
-- ----------------------------
-- Table structure for `cmf_recharge_log`
-- ----------------------------
DROP TABLE IF EXISTS `cmf_recharge_log`;
CREATE TABLE `cmf_recharge_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `type` tinyint(2) unsigned NOT NULL DEFAULT '1' COMMENT '充值方式：0线下；1微信',
  `money` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '数量',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
