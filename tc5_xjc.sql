...
-- ----------------------------
INSERT INTO `cmf_admin_menu` VALUES ('1', '0', '0', '1', '60', 'admin', 'Plugin', 'default', '', '插件中心', 'cloud', '插件中心');
...
INSERT INTO `cmf_admin_menu` VALUES ('174', '1', '1', '1', '10000', 'plugin/Wxapp', 'AdminIndex', 'index', '', '小程序管理', '', '小程序管理');
INSERT INTO `cmf_admin_menu` VALUES ('175', '174', '1', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'add', '', '添加小程序', '', '添加小程序');
INSERT INTO `cmf_admin_menu` VALUES ('176', '174', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'addPost', '', '添加小程序提交保存', '', '添加小程序提交保存');
INSERT INTO `cmf_admin_menu` VALUES ('177', '174', '1', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'edit', '', '编辑小程序', '', '编辑小程序');
INSERT INTO `cmf_admin_menu` VALUES ('178', '174', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'editPost', '', '编辑小程序提交保存', '', '编辑小程序');
INSERT INTO `cmf_admin_menu` VALUES ('179', '174', '2', '0', '10000', 'plugin/Wxapp', 'AdminWxapp', 'delete', '', '删除小程序', '', '删除小程序');
...
INSERT INTO `cmf_auth_rule` VALUES ('164', '1', 'plugin/Demo', 'plugin_url', 'plugin/Demo/AdminIndex/index', '', '演示插件', '');
INSERT INTO `cmf_auth_rule` VALUES ('165', '1', 'plugin/Demo', 'plugin_url', 'plugin/Demo/AdminIndex/setting', '', '演示插件设置', '');
INSERT INTO `cmf_auth_rule` VALUES ('166', '1', 'shop', 'admin_url', 'shop/Goods/default', '', '商品管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('167', '1', 'shop', 'admin_url', 'shop/Combo/default', '', '套餐管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('168', '1', 'shop', 'admin_url', 'shop/Order/default', '', '订单管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('169', '1', 'shop', 'admin_url', 'shop/Finance/default', '', '财务管理', '');
...
INSERT INTO `cmf_auth_rule` VALUES ('174', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminIndex/index', '', '小程序管理', '');
INSERT INTO `cmf_auth_rule` VALUES ('175', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/add', '', '添加小程序', '');
INSERT INTO `cmf_auth_rule` VALUES ('176', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/addPost', '', '添加小程序提交保存', '');
INSERT INTO `cmf_auth_rule` VALUES ('177', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/edit', '', '编辑小程序', '');
INSERT INTO `cmf_auth_rule` VALUES ('178', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/editPost', '', '编辑小程序提交保存', '');
INSERT INTO `cmf_auth_rule` VALUES ('179', '1', 'plugin/Wxapp', 'plugin_url', 'plugin/Wxapp/AdminWxapp/delete', '', '删除小程序', '');
...
INSERT INTO `cmf_hook_plugin` VALUES ('2', '10000', '1', 'switch_admin_theme', 'SwitchAdminThemeDemo');
...
INSERT INTO `cmf_option` VALUES ('2', '1', 'admin_dashboard_widgets', '[{\"name\":\"CmfHub\",\"is_system\":1},{\"name\":\"Contributors\",\"is_system\":1},{\"name\":\"MainContributors\",\"is_system\":1},{\"name\":\"Custom1\",\"is_system\":1},{\"name\":\"Custom2\",\"is_system\":1},{\"name\":\"Custom3\",\"is_system\":1},{\"name\":\"Custom4\",\"is_system\":1},{\"name\":\"Custom5\",\"is_system\":1}]');
...
INSERT INTO `cmf_option` VALUES ('6', '1', 'smtp_setting', '{\"from_name\":\"\\u8bb8\\u6cc9\\u798f\",\"from\":\"xuquanfu_2004@163.com\",\"host\":\"smtp.163.com\",\"smtp_secure\":\"ssl\",\"port\":\"465\",\"username\":\"xuquanfu_2004@163.com\",\"password\":\"lyf23327457\"}');
INSERT INTO `cmf_option` VALUES ('7', '1', 'email_template_verification_code', '{\"subject\":\"\\u6d4b\\u8bd5\",\"template\":\"&lt;p&gt;\\u60a8\\u7684\\u9a8c\\u8bc1\\u7801\\u662f\\uff1a{$code}&lt;\\/p&gt;\"}');
...
INSERT INTO `cmf_plugin` VALUES ('2', '1', '0', '1', '0', 'SwitchAdminThemeDemo', '后台模板切换演示', 'http://demo.thinkcmf.com', '', 'ThinkCMF', 'http://www.thinkcmf.com', '1.0.0', '后台模板切换演示', '{\"mobile_theme\":\"\"}');
INSERT INTO `cmf_plugin` VALUES ('4', '1', '1', '1', '0', 'Demo', '插件演示', 'http://demo.thinkcmf.com', '', 'ThinkCMF', 'http://www.thinkcmf.com', '1.0', '插件演示', '{\"custom_config\":\"0\",\"text\":\"hello,ThinkCMF!\",\"password\":\"\",\"number\":\"1.0\",\"select\":\"1\",\"checkbox\":1,\"radio\":\"1\",\"radio2\":\"1\",\"textarea\":\"\\u8fd9\\u91cc\\u662f\\u4f60\\u8981\\u586b\\u5199\\u7684\\u5185\\u5bb9\",\"date\":\"2017-05-20\",\"datetime\":\"2017-05-20\",\"color\":\"#103633\",\"image\":\"\",\"file\":\"\",\"location\":\"\"}');
INSERT INTO `cmf_plugin` VALUES ('5', '1', '1', '1', '0', 'Wxapp', '微信小程序', 'http://demo.thinkcmf.com', '', 'ThinkCMF', 'http://www.thinkcmf.com', '1.0', '微信小程序管理工具', '[]');
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', '0', '0', '1522044893', '0', '0', '0.00', '1519717629', '1', 'admin', '###0b42c94eda47bebe518f99d5ca6095c5', 'admin', 'xuquanfu_2004@163.com', '', '', '', '127.0.0.1', '', '', null);
INSERT INTO `cmf_user` VALUES ('2', '2', '0', '0', '1521529546', '2', '2', '0.00', '1519719527', '1', '', '###769202661fab217e2672f7b4bc2f40a3', '', '', '', '', '', '127.0.0.1', '', '15959284901', null);
...
-- ----------------------------
INSERT INTO `cmf_user_score_log` VALUES ('1', '2', '1519970809', 'login', '1', '1');
INSERT INTO `cmf_user_score_log` VALUES ('2', '2', '1521529546', 'login', '1', '1');
...
-- ----------------------------
INSERT INTO `cmf_user_token` VALUES ('1', '1', '1535270124', '1519718124', 'f776ca11e71c74084b517b0bc8bfa36cf776ca11e71c74084b517b0bc8bfa36c', 'web');
INSERT INTO `cmf_user_token` VALUES ('2', '2', '1537082126', '1521530126', '4c74367ba1a40df4ec033440eaca55664c74367ba1a40df4ec033440eaca5566', 'web');
INSERT INTO `cmf_user_token` VALUES ('3', '2', '1537082043', '1521530043', 'd01dc263b3d4f1354b7862dff96eca97d01dc263b3d4f1354b7862dff96eca97', 'pc');
...
-- ----------------------------
INSERT INTO `cmf_verification_code` VALUES ('1', '2', '1519722435', '1519724235', '847125', '15959284901');
